...
public interface PortfolioAPI {
    ...
    /**
     * @return all stock stockPurchases made so far.
     */
    StockPurchase[] getAllPurchases();

    /**
     * Retrieves stockPurchases made in the provided inclusive time interval
     *
     * @param startTimestamp the start timestamp of the interval
     * @param endTimestamp   the end timestamp of the interval
     * @return all stock stockPurchases made so far in the provided time interval
     */
    StockPurchase[] getAllPurchases(LocalDateTime startTimestamp, LocalDateTime endTimestamp);

    /**
     * @return the current total net worth of the portfolio: the sum of each stockPurchases' quantity multiplied by
